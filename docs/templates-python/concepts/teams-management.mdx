...
description: "Learn how to implement team functionality in your Python application using Atlas Identity Platform's REST API"
---

After setting up your [Atlas Identity Platform helper function](../getting-started/setup.mdx), you can implement comprehensive team functionality in your Python application.

## Team Management

Atlas Identity Platform provides full team management capabilities including:
...
Atlas Identity Platform includes several built-in team permissions:
