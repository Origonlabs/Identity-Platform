...
description: "Learn how to implement user authentication in your Python application using Atlas Identity Platform's REST API"
---

After creating a [helper function](../getting-started/setup.mdx) to make requests to the Atlas Identity Platform API, you can start using the API to authenticate users.

## User Authentication

Atlas Identity Platform supports multiple authentication methods:
