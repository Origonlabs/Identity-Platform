---
title: Supabase
description: Integrate Atlas Identity Platform with Supabase RLS
---

This guide shows how to integrate Atlas Identity Platform with Supabase row level security (RLS).
...
Let's create a sample table and some RLS policies to demonstrate how to integrate Atlas Identity Platform with Supabase RLS. You can apply the same logic to your own tables and policies.
<Steps>
### Setup Supabase
...
Now let's create a new Next.js project and install Atlas Identity Platform and Supabase client. (more details on [Next.js setup](https://nextjs.org/docs/getting-started/installation), [Atlas Identity Platform setup](../getting-started/setup.mdx), and [Supabase setup](https://supabase.com/docs/guides/getting-started/quickstarts/nextjs))
...
Now let's create a server action that mints a supabase JWT with the Atlas Identity Platform user ID if the user is authenticated.
...
You can find the full example [here on GitHub](https://github.com/opendex/atlas-identity-platform/tree/main/examples/supabase).
