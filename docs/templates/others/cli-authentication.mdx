...
description: How to authenticate a command line application using Atlas Identity Platform
---

If you're building a command line application that runs in a terminal, you can use Atlas Identity Platform to let your users log in to their accounts.

To do so, we provide a Python template that you can use as a starting point. [Download it here](https://github.com/opendex/atlas-identity-platform/tree/main/docs/public/stack_auth_cli_template.py) and copy it into your project, for example:
...
def stack_auth_request(method, endpoint, **kwargs):
  # ... see Atlas Identity Platform's Getting Started section to see how this function should look like
  # https://docs.opendex.com/python/getting-started/setup
