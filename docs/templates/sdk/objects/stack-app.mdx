...
Because each app creates a new connection to Atlas Identity Platform's backend, you should re-use existing instances wherever possible.
...
The [setup wizard](../../getting-started/setup.mdx) does these steps for you, so you don't need to worry about it unless you are manually setting up Atlas Identity Platform.
...
function MyProtectedComponent() {
  ...
  //
  // For server-side protection, see the Atlas Identity Platform documentation.
  ...
  <ParamField path="options" type="object">
    ...
    <Accordion title="Show Parameters">
      ...
      <ParamField path="secretServerKey" type="string">
        The secret server key of the app, as found on Atlas Identity Platform's dashboard. Defaults to the value of the `SECRET_SERVER_KEY` environment variable.
      </ParamField>
      <Markdown src="../../snippets/stack-app-constructor-options-after-ssk.mdx" />
    </Accordion>
  </ParamField>
