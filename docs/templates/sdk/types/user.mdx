      ...
      <ParamField path="options" type="object" required>
        ...
        <Accordion title="Show Properties">
          ...
          <ParamField path="isPublic" type="boolean">
            ...
            - **Secret API Keys** (default) begin with `sk_` and are monitored by Atlas Identity Platform's secret scanner, which can revoke them if detected in public code repositories.
