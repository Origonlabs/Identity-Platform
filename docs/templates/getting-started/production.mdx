  ...
  On the provider's website, create an OAuth app and set the callback URL to the corresponding Stack callback URL. Copy the client ID and client secret.
   ...
   <Tabs defaultValue="google">
    ...
    <TabsContent value="google">
      ...
      Callback URL:
      ```
      https://api.opendex.com/api/v1/auth/oauth/callback/google
      ```
    </TabsContent>
    ...
    <TabsContent value="github">
      ...
      Callback URL:
      ```
      https://api.opendex.com/api/v1/auth/oauth/callback/github
      ```
    </TabsContent>
    ...
    <TabsContent value="facebook">
      ...
      Callback URL:
      ```
      https://api.opendex.com/api/v1/auth/oauth/callback/facebook
      ```
    </TabsContent>
    ...
    <TabsContent value="microsoft">
      ...
      Callback URL:
      ```
      https://api.opendex.com/api/v1/auth/oauth/callback/microsoft
      ```
    </TabsContent>
    ...
    <TabsContent value="spotify">
      ...
      Callback URL:
      ```
      https://api.opendex.com/api/v1/auth/oauth/callback/spotify
      ```
    </TabsContent>
    ...
    <TabsContent value="gitlab">
      ...
      Callback URL:
      ```
      https://api.opendex.com/api/v1/auth/oauth/callback/gitlab
      ```
    </TabsContent>
    ...
    <TabsContent value="bitbucket">
      ...
      Callback URL:
      ```
      https://api.opendex.com/api/v1/auth/oauth/callback/bitbucket
      ```
    </TabsContent>
    ...
    <TabsContent value="linkedin">
      ...
      Callback URL:
      ```
      https://api.opendex.com/api/v1/auth/oauth/callback/linkedin
      ```
    </TabsContent>
    ...
    <TabsContent value="x">
      ...
      Callback URL:
      ```
      https://api.opendex.com/api/v1/auth/oauth/callback/x
      ```
    </TabsContent>
   </Tabs>
<Step>
