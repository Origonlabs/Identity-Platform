...
This guide demonstrates how to integrate Atlas Identity Platform with Vite. The same principles apply to other JavaScript frameworks as well. You can find the complete example code in our [GitHub repository](https://github.com/opendex/atlas-identity-platform/tree/main/examples/js-example).
...
<Tabs defaultValue="html">
  ...
  <TabsContent value="html">
    ...
    <head>
      ...
      <title>Atlas Identity Platform JS Examples</title>
    </head>
    <body>
      <h1>Atlas Identity Platform JS Examples</h1>
