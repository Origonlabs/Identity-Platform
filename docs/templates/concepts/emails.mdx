...
For development and testing, you can use Stack's shared email provider. This sends emails from `noreply@opendex.co` and is configured through your project settings in the Atlas Identity Platform dashboard.
