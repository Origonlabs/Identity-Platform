...
Atlas Identity Platform provides prebuilt UI components for the users and teams to manage their own API keys.
...
sequenceDiagram
    ...
    participant Stack as Atlas Identity Platform Service
...
Atlas Identity Platform provides two types of API keys:
...
## Setting Up API Keys in Atlas Identity Platform

To use API keys in your application, you need to enable them in your project settings. Navigate to the Atlas Identity Platform dashboard, select your project, and enable User API Keys and/or Team API Keys in the project settings.
