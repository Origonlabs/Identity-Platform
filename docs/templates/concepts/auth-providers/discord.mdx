...
This guide explains how to set up Discord as an authentication provider with Atlas Identity Platform. Discord OAuth2 allows users to sign in to your application using their Discord account.
...
<Steps>
  ...
  5. Under **Redirects** add `https://api.opendex.com/api/v1/auth/oauth/callback/discord`
  ...
  <Step>
  ### Enable Discord OAuth2 in Atlas Identity Platform
...
When a user signs in with Discord, Atlas Identity Platform will create a user profile with the following data:
...
- Visit our [Discord Support Channel](mailto:support@opendex.com)
