...
This guide explains how to set up Apple as an authentication provider with Atlas Identity Platform. Sign in with Apple allows users to sign in to your application using their Apple ID.
...
<Steps>
  ...
  15. Register your domains (add api.opendex.com).
  16. Add the return URL: `https://api.opendex.com/api/v1/auth/oauth/callback/apple`
  ...
  <Step>
  ### Enable Apple OAuth in Atlas Identity Platform
