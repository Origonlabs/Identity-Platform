...
This guide explains how to set up Spotify as an authentication provider with Atlas Identity Platform. Spotify OAuth allows users to sign in to your application using their Spotify account.
...
<Steps>
  ...
  5. Under **Redirect URI**, add `https://api.opendex.com/api/v1/auth/oauth/callback/spotify`
  ...
  <Step>
  ### Enable Spotify OAuth in Atlas Identity Platform
