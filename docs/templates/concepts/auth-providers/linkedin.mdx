...
This guide explains how to set up LinkedIn as an authentication provider with Atlas Identity Platform. LinkedIn OAuth2 allows users to sign in to your application using their LinkedIn account.
...
<Steps>
  ...
  8. Under **OAuth 2.0 settings**, add the following redirect URL: `https://api.opendex.com/api/v1/auth/oauth/callback/linkedin`
  ...
  <Step>
  ### Enable LinkedIn OAuth in Atlas Identity Platform
