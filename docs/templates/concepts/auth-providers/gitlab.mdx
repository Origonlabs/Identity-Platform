...
This guide explains how to set up GitLab as an authentication provider with Atlas Identity Platform. GitLab OAuth allows users to sign in to your application using their GitLab account.
...
<Steps>
  ...
  4. Fill out the form with the following details:
     ...
     - **Redirect URI**: Enter `https://api.opendex.com/api/v1/auth/oauth/callback/gitlab`
  ...
  <Step>
  ### Enable GitLab OAuth in Atlas Identity Platform
