...
This guide explains how to set up Twitch as an authentication provider with Atlas Identity Platform. Twitch OAuth allows users to sign in to your application using their Twitch account.
...
<Steps>
  ...
  5. Under **OAuth Redirect URLs**, add `https://api.opendex.com/api/v1/auth/oauth/callback/twitch`
  6. Click **Create**.
  ...
  <Step>
  ### Enable Twitch OAuth in Atlas Identity Platform
