...
Atlas Identity Platform supports a wide range of authentication providers to help you add secure authentication to your application. This documentation covers all the supported providers and how to configure them.
...
Each provider has its own setup process and configuration requirements. Select a provider from the navigation to learn more about how to configure it with Atlas Identity Platform. 
