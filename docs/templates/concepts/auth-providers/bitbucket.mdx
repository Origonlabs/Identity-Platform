...
This guide explains how to set up Bitbucket as an authentication provider with Atlas Identity Platform. Bitbucket OAuth allows users to sign in to your application using their Bitbucket account.
...
<Steps>
  ...
  5. Fill out the form with the following details:
     ...
     - **Callback URL**: Enter `https://api.opendex.com/api/v1/auth/oauth/callback/bitbucket`
  ...
  <Step>
  ### Enable Bitbucket OAuth in Atlas Identity Platform
