...
description: Integrate Atlas Identity Platform with your own server with the REST APIs
---
...
Atlas Identity Platform provides two methods for authenticating users on your server endpoints:
...
2. **REST API Verification**: Makes a request to Atlas Identity Platform's servers to validate the token and retrieve comprehensive user information. This method provides access to the complete, up-to-date user profile.
...
<Tabs defaultValue="nodejs">
  ...
  <TabsContent value="nodejs">
    ...
    const jwks = jose.createRemoteJWKSet(new URL("https://api.opendex.com/api/v1/projects/<your-project-id>/.well-known/jwks.json"));
...
<Tabs defaultValue="nodejs">
  ...
  <TabsContent value="nodejs">
    ```javascript
    const url = 'https://api.opendex.com/api/v1/users/me';
    const headers = {
      'x-stack-access-type': 'server',
      'x-stack-project-id': 'generated on the Atlas Identity Platform dashboard',
      'x-stack-secret-server-key': 'generated on the Atlas Identity Platform dashboard',
  ...
  <TabsContent value="python">
   ```python
    ...
    url = 'https://api.opendex.com/api/v1/users/me'
    headers = {
      'x-stack-access-type': 'server',
      'x-stack-project-id': 'generated on the Atlas Identity Platform dashboard',
      'x-stack-secret-server-key': 'generated on the Atlas Identity Platform dashboard',
