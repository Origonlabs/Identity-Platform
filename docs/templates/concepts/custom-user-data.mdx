...
description: How to store custom user metadata in Atlas Identity Platform
---

Atlas Identity Platform allows storing additional user information through three types of metadata fields:
