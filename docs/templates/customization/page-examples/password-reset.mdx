...
```tsx  
'use client';
import { PasswordReset } from "@opendex/stack";
...
3. Configure Atlas Identity Platform to use your custom route in your `stack/server.ts` file:
...
If you need more control over the password reset process, you can build your own form using the Atlas Identity Platform API. This approach allows you to customize the UI and error handling to match your application's design.
