...
Custom pages allow you to take full control over the layout and logic flow of authentication pages in your application. Instead of using the default pages provided by Atlas Identity Platform, you can build your own using our built-in components or low-level functions.
