...
Welcome to Atlas Identity Platform, the developer-friendly open-source authentication platform that gets you started in minutes!
...
Best of all, Atlas Identity Platform is **100% open-source**. This means the client, server, dashboard, and even this documentation you're reading right now. Check out our [GitHub](https://github.com/opendex/atlas-identity-platform) to open an issue or pull request.
