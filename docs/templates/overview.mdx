...
Welcome to Atlas Identity Platform, the developer-friendly authentication platform that gets you started in minutes!
...
<CardGroup>
  ...
  >
    Get started with Atlas Identity Platform in 5 minutes
  </Card>
  ...
  <Card 
    ...
    href="./sdk"
  >
    Learn how to use Atlas Identity Platform's SDK
  </Card>
  {/* END_PLATFORM */}
  <Card 
    ...
    href="/api/overview"
  >
    Explore Atlas Identity Platform's REST APIs
  </Card>
</CardGroup>

Still have questions? Check out our [FAQ](./faq) or [join our Discord](mailto:support@opendex.com).

## Why Choose Atlas Identity Platform?
...
The optimal authentication solution should be secure, yet approachable. If developers need to worry about JWTs, OAuth flows, or password hashing, then the authentication solution has failed its purpose.
...
That's it! Atlas Identity Platform will either return a User object or redirect the user to the login page.
...
Atlas Identity Platform is available under a proprietary commercial license from Opendex, Inc. Contact support for licensing and deployment options.

This is just a glimpse of what Atlas Identity Platform can do. We also handle many other tasks like backend integration, data storage, emails, teams, permissions, and more, which you will learn about later in the documentation.

If this sounds interesting, [get started](./getting-started/setup) with our interactive setup wizard, or join [our Discord community](mailto:support@opendex.com) to ask questions and get help from our team.
