  ...
  const footerLinks = [
    {
      title: "Product",
      links: [
        { name: "Website", href: "https://opendex.com" },
        { name: "Dashboard", href: "https://dashboard.opendex.com/projects" }
      ]
    },
    {
      title: "Community",
      links: [
        { name: "GitHub", href: "https://github.com/opendex/atlas-identity-platform" },
        { name: "Support", href: "mailto:support@opendex.com" }
      ]
    },
    {
      title: "Company",
      links: [
        { name: "Careers", href: "https://opendex.com/careers" }
      ]
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">Atlas Identity Platform</span>
            </div>
