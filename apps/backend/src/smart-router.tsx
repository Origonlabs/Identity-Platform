...
import { numberCompare } from "@opendex/stack-shared/dist/utils/numbers";


// SmartRouter may be imported on the edge, so we can't import fs at the top level
// hence, we define some wrapper functions
const listRecursively: typeof import("@opendex/stack-shared/dist/utils/fs").listRecursively = async (...args) => {
  // SmartRouter may be imported on the edge, so we can't import fs at the top level
  // hence, this wrapper function
  const m = await import("@opendex/stack-shared/dist/utils/fs");
