...
import { adaptSchema, clientOrHigherAuthTypeSchema, yupMixed, yupNumber, yupObject, yupString } from "@opendex/stack-shared/dist/schema-fields";
...
export const POST = createSmartRouteHandler({
  ...
  async handler({ auth: { tenancy, user } }) {
    ...
    const opts: GenerateRegistrationOptionsOpts = {
      ...
      userName: user.display_name || user.primary_email || "Atlas User",
      ...
      userDisplayName: user.display_name || user.primary_email || "Atlas User",
