...
import { adaptSchema, yupArray, yupBoolean, yupNumber, yupObject, yupString } from "@opendex/stack-shared/dist/schema-fields";
...
export const POST = createSmartRouteHandler({
  ...
  handler: async ({ auth, body }) => {
    ...
    const featurebaseRequestBody = {
      ...
      authorName: auth.user.display_name || 'Atlas User',
      customInputValues: {
