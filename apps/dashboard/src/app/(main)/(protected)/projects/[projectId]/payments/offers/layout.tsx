...
function SetupPaymentsButton({ setupPayments }: { setupPayments: () => Promise<void> }) {
    ...
    return (
      <>
        ...
        <ActionDialog
          ...
          description="You will be redirected to Stripe, our partner for payment processing, to connect your bank account. Or, you can do this later, and test Atlas Identity Platform Payments without setting up Stripe, but you will be limited to test transactions."
          cancelButton={false}
          okButton={false}
        >
  ...
  return (
    <>
      ...
      >
        <div className="mb-4">
          Atlas Identity Platform Payments is currently only available in the US. If you&apos;d like to be notified when we expand to other countries, please reach out to us on our{" "}
          <Link href="https://feedback.opendex.com" target="_blank" className="underline">
            Feedback platform
          </Link>
          .
        </div>
