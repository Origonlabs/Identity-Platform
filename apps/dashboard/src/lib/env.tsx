...
function getInlineEnvVar(name: string) {
  return process.env[name.replace('STACK_', 'ATLAS_')] ?? process.env[name];
}

const _inlineEnvVars = {
  NEXT_PUBLIC_STACK_API_URL: getInlineEnvVar('NEXT_PUBLIC_STACK_API_URL'),
  NEXT_PUBLIC_BROWSER_STACK_API_URL: getInlineEnvVar('NEXT_PUBLIC_BROWSER_STACK_API_URL'),
  NEXT_PUBLIC_SERVER_STACK_API_URL: getInlineEnvVar('NEXT_PUBLIC_SERVER_STACK_API_URL'),
  NEXT_PUBLIC_STACK_DASHBOARD_URL: getInlineEnvVar('NEXT_PUBLIC_STACK_DASHBOARD_URL'),
  NEXT_PUBLIC_BROWSER_STACK_DASHBOARD_URL: getInlineEnvVar('NEXT_PUBLIC_BROWSER_STACK_DASHBOARD_URL'),
  NEXT_PUBLIC_SERVER_STACK_DASHBOARD_URL: getInlineEnvVar('NEXT_PUBLIC_SERVER_STACK_DASHBOARD_URL'),
  NEXT_PUBLIC_POSTHOG_KEY: getInlineEnvVar('NEXT_PUBLIC_POSTHOG_KEY'),
  NEXT_PUBLIC_STACK_SVIX_SERVER_URL: getInlineEnvVar('NEXT_PUBLIC_STACK_SVIX_SERVER_URL'),
  NEXT_PUBLIC_SENTRY_DSN: getInlineEnvVar('NEXT_PUBLIC_SENTRY_DSN'),
  NEXT_PUBLIC_VERSION_ALERTER_SEVERE_ONLY: getInlineEnvVar('NEXT_PUBLIC_VERSION_ALERTER_SEVERE_ONLY'),
  NEXT_PUBLIC_STACK_EMULATOR_ENABLED: getInlineEnvVar('NEXT_PUBLIC_STACK_EMULATOR_ENABLED'),
  NEXT_PUBLIC_STACK_EMULATOR_PROJECT_ID: getInlineEnvVar('NEXT_PUBLIC_STACK_EMULATOR_PROJECT_ID'),
  NEXT_PUBLIC_STACK_PROJECT_ID: getInlineEnvVar('NEXT_PUBLIC_STACK_PROJECT_ID'),
  NEXT_PUBLIC_STACK_PUBLISHABLE_CLIENT_KEY: getInlineEnvVar('NEXT_PUBLIC_STACK_PUBLISHABLE_CLIENT_KEY'),
  NEXT_PUBLIC_STACK_URL: getInlineEnvVar('NEXT_PUBLIC_STACK_URL'),
  NEXT_PUBLIC_STACK_INBUCKET_WEB_URL: getInlineEnvVar('NEXT_PUBLIC_STACK_INBUCKET_WEB_URL'),
  NEXT_PUBLIC_STACK_ENABLE_DEVELOPMENT_FEATURES_PROJECT_IDS: getInlineEnvVar('NEXT_PUBLIC_STACK_ENABLE_DEVELOPMENT_FEATURES_PROJECT_IDS'),
  NEXT_PUBLIC_STACK_STRIPE_PUBLISHABLE_KEY: getInlineEnvVar('NEXT_PUBLIC_STACK_STRIPE_PUBLISHABLE_KEY')
} as const;
