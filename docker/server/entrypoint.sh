...
# Allow Atlas-prefixed env vars as aliases, while keeping Stack-prefixed vars as the internal contract.
alias_env_if_unset STACK_FORWARD_MOCK_OAUTH_SERVER ATLAS_FORWARD_MOCK_OAUTH_SERVER
alias_env_if_unset STACK_SKIP_MIGRATIONS ATLAS_SKIP_MIGRATIONS
alias_env_if_unset STACK_SKIP_SEED_SCRIPT ATLAS_SKIP_SEED_SCRIPT

alias_env_if_unset STACK_DATABASE_CONNECTION_STRING ATLAS_DATABASE_CONNECTION_STRING
alias_env_if_unset STACK_SECRET_SERVER_KEY ATLAS_SECRET_SERVER_KEY
alias_env_if_unset STACK_SUPER_SECRET_ADMIN_KEY ATLAS_SUPER_SECRET_ADMIN_KEY
alias_env_if_unset STACK_SVIX_SERVER_URL ATLAS_SVIX_SERVER_URL
alias_env_if_unset STACK_FEATUREBASE_JWT_SECRET ATLAS_FEATUREBASE_JWT_SECRET

alias_env_if_unset NEXT_PUBLIC_STACK_API_URL NEXT_PUBLIC_ATLAS_API_URL
alias_env_if_unset NEXT_PUBLIC_BROWSER_STACK_API_URL NEXT_PUBLIC_BROWSER_ATLAS_API_URL
alias_env_if_unset NEXT_PUBLIC_SERVER_STACK_API_URL NEXT_PUBLIC_SERVER_ATLAS_API_URL
alias_env_if_unset NEXT_PUBLIC_STACK_DASHBOARD_URL NEXT_PUBLIC_ATLAS_DASHBOARD_URL
alias_env_if_unset NEXT_PUBLIC_BROWSER_STACK_DASHBOARD_URL NEXT_PUBLIC_BROWSER_ATLAS_DASHBOARD_URL
alias_env_if_unset NEXT_PUBLIC_SERVER_STACK_DASHBOARD_URL NEXT_PUBLIC_SERVER_ATLAS_DASHBOARD_URL
alias_env_if_unset NEXT_PUBLIC_STACK_PROJECT_ID NEXT_PUBLIC_ATLAS_PROJECT_ID
alias_env_if_unset NEXT_PUBLIC_STACK_PUBLISHABLE_CLIENT_KEY NEXT_PUBLIC_ATLAS_PUBLISHABLE_CLIENT_KEY
alias_env_if_unset NEXT_PUBLIC_STACK_SVIX_SERVER_URL NEXT_PUBLIC_ATLAS_SVIX_SERVER_URL
