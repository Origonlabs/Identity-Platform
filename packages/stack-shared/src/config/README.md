...
## Generic format vs. Atlas Identity Platform

The config format is generally usable and not specific to Atlas Identity Platform.

All the logic required for generic usage of the config format are in `format/`. The other files in this folder are specific to Atlas Identity Platform's usage of it.
...
**Atlas Identity Platform**: There are four levels, project, branch, environment, organization.
- Base config: The defaults that come with Atlas Identity Platform
